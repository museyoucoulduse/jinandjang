...
class PositivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create positive" do
    assert_difference('Positive.count') do
      post positives_url, params: { positive: { description: @positive.description, title: @positive.title, when: @positive.when } }
    end
  ...
  test "should update positive" do
    patch positive_url(@positive), params: { positive: { description: @positive.description, title: @positive.title, when: @positive.when } }
